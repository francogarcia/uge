...
#include "GameStates/GameStateFactory.h"
...
namespace pg
{
    ...
    {
        friend class pg::GameState::Running;
    ...
    public:
        ...
        {
            uge::EventListenerDelegate functionDelegate = fastdelegate::MakeDelegate(this, &pg::GameLogic::ActorCreatedDelegate);
