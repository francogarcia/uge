...
#include <IO/Output/Audio/Implementation/OpenALSoft/OpenALSoftAudioBuffer.h>
...
namespace uge
{
    ...
    namespace Component
    {
        ...
        class OpenALSoftAudioComponent;
        typedef std::shared_ptr<OpenALSoftAudioComponent> OpenALSoftAudioComponentSharedPointer;
        typedef std::weak_ptr<OpenALSoftAudioComponent> OpenALSoftAudioComponentWeakPointer;

        class OpenALSoftAudioComponent : public IAuditoryComponent
        {
        public:
             ...
             *  Construtor.
             */
            OpenALSoftAudioComponent();

            /**
             *  Destructor.
             */
            virtual ~OpenALSoftAudioComponent();
